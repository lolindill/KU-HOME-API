...
function green($t)
{
    ...
    return $COLOR ? "\033[32m{$t}\033[0m" : $t;
}
function red($t)
{
    global $COLOR;

    return $COLOR ? "\033[31m{$t}\033[0m" : $t;
}
function yellow($t)
{
    global $COLOR;

    return $COLOR ? "\033[33m{$t}\033[0m" : $t;
}
function cyan($t)
{
    global $COLOR;

    return $COLOR ? "\033[36m{$t}\033[0m" : $t;
}
function bold($t)
{
    global $COLOR;

    return $COLOR ? "\033[1m{$t}\033[0m" : $t;
}
